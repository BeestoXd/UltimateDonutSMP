...
final class NativeGameProfileFactory {
    ...
    private static Object createPropertyMap(Class<?> propertyMapType, Object textureProperty) {
        if (propertyMapType == null || textureProperty == null) return null;
        ...
        for (Constructor<?> constructor : propertyMapType.getDeclaredConstructors()) {
            ...
            try {
                ...
                if (parameters.length == 0) {
                    ...
                    if (mutateContainer(propertyMap, textureProperty)) return propertyMap;
                }
    ...
    private static WrappedGameProfile fallbackProfile(
            UUID profileId, String profileName, String textureValue, String textureSignature) {
    ...
    private static void cacheWrappedTexture(
            WrappedGameProfile profile, String textureValue, String textureSignature) {
        if (profile == null || textureValue == null || textureValue.isBlank()) return;
        try {
