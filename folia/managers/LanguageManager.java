...
public class LanguageManager {
    ...
    public Component component(String path, Player player, String legacyFallback, String... placeholders) {
        return ColorUtils.toComponent(text(path, legacyFallback, null, placeholders), player);
    }

    public List<Component> components(String path, Player player, List<String> legacyFallback, String... placeholders) {
        return list(path, legacyFallback, placeholders).stream()
                .map(line -> ColorUtils.toComponent(line, player))
                .toList();
    }
